<?php
add_action( 'customize_register', 'themewagon_customize_register' );
function themewagon_customize_register($wp_customize) {
        ...
        public function render_content() {
            $dropdown = wp_dropdown_categories(
                array(
                    ...
                    'echo'              => 0,
                    'show_option_none'  => __( '&mdash; Select &mdash;', 'yellowstone' ),
                    'option_none_value' => '0',
                    'selected'          => $this->value(),
                )
            );
