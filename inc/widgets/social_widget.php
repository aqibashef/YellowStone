...
add_action( 'widgets_init', 'themewagon_social_load_widget' );

function themewagon_social_load_widget() {
	register_widget( 'themewagon_social_widget' );
}

class themewagon_social_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function themewagon_social_widget() {
		/* Widget settings. */
