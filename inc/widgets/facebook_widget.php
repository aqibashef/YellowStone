...
add_action( 'widgets_init', 'themewagon_facebook_load_widget' );

function themewagon_facebook_load_widget() {
	register_widget( 'themewagon_facebook_widget' );
}
...
class themewagon_facebook_widget extends WP_Widget {
	...
	public function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'themewagon_facebook_widget', 'description' => __('A widget that displays a Facebook Like Box', 'yellowstone') );

		parent::__construct( 'yellowstone', 'Yellowstone: Facebook Like Box', $widget_ops );
	}
