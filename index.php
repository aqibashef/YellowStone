<?php get_header(); ?>
	...
	<div class="container">
		...
		<div id="content">
			...
			<div id="main" <?php if(get_theme_mod('ys_sidebar_homepage') == true) : ?>class="fullwidth"<?php endif; ?>>
				
				<?php if(get_theme_mod('ys_home_layout') == 'grid' || get_theme_mod('ys_home_layout') == 'full_grid') : ?><ul class="sp-grid"><?php endif; ?>
...
<?php if(get_theme_mod('ys_sidebar_homepage')) : else : ?><?php get_sidebar(); ?><?php endif; ?>
<?php get_footer(); ?>